...
SignalPath = '/home/jupyter-blonsbro/Combined Signal Ntuples.root'
EWKBackgroundPath = '/home/jupyter-blonsbro/Combined EWKBackground Ntuples.root'
QCDBackgroundPath = '/home/jupyter-blonsbro/Combined QCDBackground Ntuples.root'
...
X = rawdata.drop(["mjj", "weight"], axis=1)
...
def compare_train_test(kModel, X_train_df, y_train, X_test_df, y_test, bins=40):
    """
    ...
    axes[1].hist(worthy_bkg['mjj'], bins=100, weights=worthy_bkg['weight'], color='red', alpha=0.5, label='Background Mjj')
    axes[1].hist(worthy_sig['mjj'], bins=100, weights=worthy_sig['weight'], color='blue', alpha=0.5, label='Signal Mjj')
    axes[1].legend()
...
def checkTraining(model,kModel):
    ...
    compare_train_test(kModel, X_train_df, y_train, X_test_df, y_test)
